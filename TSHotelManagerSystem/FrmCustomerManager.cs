        ...
        private void picShow_Click(object sender, EventArgs e)
        {
            ...
            else if (n == 1)
            {
                ...
                if (ret == DialogResult.Yes)
                {
                    ...
                    o.Operationlog = LoginInfo.WorkerClub + LoginInfo.WorkerName + "于" + DateTime.Now + "查看了" + txtCustoNo.Text + "的证件号码!";
                    o.OperationAccount = LoginInfo.WorkerClub + LoginInfo.WorkerName;
                    #endregion
