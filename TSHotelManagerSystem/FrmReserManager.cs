...
namespace TSHotelManagerSystem
{
    public partial class FrmReserManager : Form
    {
        ...
        {
            string sql1 = string.Format("insert Reser values('" + txtCustoName.Text + "','" + txtCustoTel.Text + "','" + cboReserWay.Text + "','" + cboReserRoomNo.Text + "','" + dtpBouDate.Value.ToString() + "','" + dtpEndDate.Value.ToString() + "','" + txtRemark.Text + "')");
