...
namespace SYS.FormUI
{
    public partial class WtiInfo : Form
    {
        ...
        {
            //将水电费信息加载到Dgv
            dgvWti.DataSource = WtiManager.SelectWtiInfoAll();
        }
        #endregion
        ...
        private void picDelete_Click(object sender, EventArgs e)
        {
            if (CheckInput())//检查输入完整性
            {
                ...
                if (dr == DialogResult.Yes)//判断操作员是否删除水电费信息
                {
                    ...
                    //执行语句
                    n = WtiManager.DeleteWtiInfoByRoomNoAndDateTime(no, usedate, enddate);
        ...
        private void picUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (txtRoomNo.Text != "" && dtpUseDate.Text != "" && dtpEndDate.Text != "")
            {
                ...
                Wti w = WtiManager.SelectWtiInfoByRoomNoAndTime(no, usedate, enddate);
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            if (btnOk.Text == "修改")
            {
                ...
                if (water != w.WaterUse.ToString() || power != w.PowerUse.ToString())
                {
                    ...
                    int n = WtiManager.UpdateWtiInfoByRoomNoAndDateTime(w2);
                    if (n > 0)
                    {
